...
class Config:
    ...
    BOT_TOKEN = getenv("BOT_TOKEN", "8515220177:AAGQ5be8wn-utjxSqQ5_YR5b_eaAvHf8kGM")

    # Admin / Owner IDs (space-separated)
    SUDO = list(map(int, getenv(
        "SUDO",
        "7554081592 6697940650 7564050858 5656436152"
    ).split()))
    ...
    # Posts to copy
    POSTS = [
        "https://t.me/forward_hack_lnx/268",
        "https://t.me/forward_hack_lnx/269",
        "https://t.me/forward_hack_lnx/270",
        "https://t.me/forward_hack_lnx/271"
    ]
